...
//        [_logoImageView sd_setImageWithURL:[NSURL URLWithString:messageModel.photoUrl] placeholderImage:[UIImage imageNamed:@"w"]];

        KZUser *user = [KZAppManager loadUserInfo];
        [_logoImageView sd_setImageWithURL: [NSURL URLWithString: user.avatar]];
    ...
    else
    {
       // _logoImageView.image = [UIImage imageNamed:@"m"];
        [_logoImageView sd_setImageWithURL:[NSURL URLWithString:messageModel.photoUrl] placeholderImage:[UIImage imageNamed:@"m"]];
